# Deep.BI Connectors for PyFlink


## Periodic JDBC Source

A periodic JDBC source reads a JDBC compliant database by using provided query. To create a source you can use following code:
